...
from formatConversion.xml2Midi.convert import convert_score
from formatConversion.xml2Midi.utils import get_dest_midi_path

raw_path = "../../data/musicxml"
...
def musicxmlToMidi(raw_path: str, output_path: str):
...
if __name__ == "__main__":
    # musicxmlToMidi(raw_path, output_path)
    pass
